...
export const createDescription = ({ name = 'Company', region, country = 'Japan', trains = [], totalTrains = 0, totalCompositions = 0 } = {}) => {
  ...
  if (region) description += ` in the ${region} region, ${country}`
  else description += ` in ${country}`
